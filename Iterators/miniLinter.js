...
/*split locate space and split every word in the string*/
let storyWords = story.split(' ')
//console.log(storyWords)

// get all word from unnecessaryWords and removes removes them from storyWord
...
// Now count how maby sentences are in the paragraph, remember sentences end with (.) and (!)
